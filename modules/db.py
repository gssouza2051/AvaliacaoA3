...
def atendimentos_adicionar(nome_entry, medico_options, data_consulta_entry, horario_options, especialidade_options, cpf_valor):
    engine = conecta_db()
...
def atendimentos_pesquisar(nome_entry, medico_options, data_consulta_entry, horario_options, plano_saude_options, status_options, especialidade_options, cpf_valor):
    engine = conecta_db()
...
def receita_adicionar(nome_entry, medico_options, medicamento_entry, atestado_entry, descricao_entry, data_consulta_entry, horario_options, cpf_valor):
    engine = conecta_db()
...
def receita_pesquisar(medico_options, data_consulta_entry, horario_options, cpf_valor):
    engine = conecta_db()
